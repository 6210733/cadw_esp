...
class EnregistrementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('avatar')) {
            ...
            // Générer un avatar par défaut depuis Pravatar
            $avatarSize = 150; // Choisissez la taille souhaitée
            $defaultAvatarUrl = "https://i.pravatar.cc/{$avatarSize}?u=" . $user->email;
            dd($defaultAvatarUrl);
        ...
        return redirect()
                ...
                ->with('success', 'Votre compte a été créé');
